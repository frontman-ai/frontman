...
These are currently approved cross-boundary contracts:

- `FrontmanServer.Organizations.Organization`
  - Owner boundary: `FrontmanServer.Organizations`
  - Exported in: `apps/frontman_server/lib/frontman_server/organizations.ex`
  - Consumer example: `FrontmanServer.Accounts.Scope`
- `FrontmanServer.Accounts.Scope`
  - Owner boundary: `FrontmanServer.Accounts`
  - Exported in: `apps/frontman_server/lib/frontman_server/accounts.ex`
  - Consumer examples: `FrontmanServer.Tasks.*`, `FrontmanServerWeb.*`
- `FrontmanServer.Accounts.User`
  - Owner boundary: `FrontmanServer.Accounts`
  - Exported in: `apps/frontman_server/lib/frontman_server/accounts.ex`
  - Consumer examples: workers and web registration/auth flows
- `FrontmanServer.Accounts.WorkOS.AuthError`
  - Owner boundary: `FrontmanServer.Accounts`
  - Exported in: `apps/frontman_server/lib/frontman_server/accounts.ex`
  - Consumer example: websocket auth error shaping in web layer
- `FrontmanServer.Providers.Model`
  - Owner boundary: `FrontmanServer.Providers`
  - Exported in: `apps/frontman_server/lib/frontman_server/providers.ex`
  - Consumer example: task channel model parsing/formatting
- `FrontmanServer.Providers.Registry`
  - Owner boundary: `FrontmanServer.Providers`
  - Exported in: `apps/frontman_server/lib/frontman_server/providers.ex`
  - Consumer example: model/options capability surfaces in web layer
- `FrontmanServer.Providers.OAuthToken`
  - Owner boundary: `FrontmanServer.Providers`
  - Exported in: `apps/frontman_server/lib/frontman_server/providers.ex`
  - Consumer example: OAuth callback and token expiry handling
- `FrontmanServer.Providers.AnthropicOAuth`
  - Owner boundary: `FrontmanServer.Providers`
  - Exported in: `apps/frontman_server/lib/frontman_server/providers.ex`
  - Consumer example: OAuth flow bootstrap in controllers
- `FrontmanServer.Providers.ChatGPTOAuth`
  - Owner boundary: `FrontmanServer.Providers`
  - Exported in: `apps/frontman_server/lib/frontman_server/providers.ex`
  - Consumer example: OAuth flow bootstrap in controllers
- `FrontmanServer.Providers.ResolvedKey`
  - Owner boundary: `FrontmanServer.Providers`
  - Exported in: `apps/frontman_server/lib/frontman_server/providers.ex`
  - Consumer example: task execution/title generation LLM request setup
- `FrontmanServer.Tasks.Execution`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: task channel runtime controls
- `FrontmanServer.Tasks.Execution.Framework`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: framework capability detection in tasks channel
- `FrontmanServer.Tasks.Interaction`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: ACP event shaping in task channel
- `FrontmanServer.Tasks.Interaction.UserMessage`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: interaction test support builders
- `FrontmanServer.Tasks.Interaction.AgentResponse`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: interaction test support builders
- `FrontmanServer.Tasks.Interaction.AgentCompleted`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: websocket event classification
- `FrontmanServer.Tasks.Interaction.AgentError`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: websocket event classification
- `FrontmanServer.Tasks.Interaction.ToolCall`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: websocket event classification
- `FrontmanServer.Tasks.Interaction.ToolResult`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: websocket event classification
- `FrontmanServer.Tasks.Todos.Todo`
  - Owner boundary: `FrontmanServer.Tasks`
  - Exported in: `apps/frontman_server/lib/frontman_server/tasks.ex`
  - Consumer example: todos ACP serialization
