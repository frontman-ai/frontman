defmodule FrontmanServer.Tasks.TodosTest do
  ...
  describe "projection from tool results" do
    test "rebuilds state from tool result interactions", %{task_id: task_id} do
      ...
      Tasks.add_tool_result(task_id, %{id: "call1", name: "todo_add"}, todo1, false)
      Tasks.add_tool_result(task_id, %{id: "call2", name: "todo_add"}, todo2, false)
    ...
    test "applies removal correctly", %{task_id: task_id} do
      ...
      Tasks.add_tool_result(task_id, %{id: "c3", name: "todo_remove"}, todo1.id, false)
