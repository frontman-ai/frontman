defmodule FrontmanServer.Workers.SendSupportQuestionToDiscordTest do
  ...
  test "posts the full question with mentions disabled and an untrusted label" do
    ...
    assert options[:url] == "https://discord.test/support-secret"
  ...
  test "missing shared webhook cancels queued jobs rather than pretending they were sent" do
    Application.put_env(:frontman_server, SendAgentFeedbackToDiscord, webhook_url: nil)
