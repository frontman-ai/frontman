defmodule FrontmanServer.Test.Fixtures.Tasks do
  ...
  def task_fixture(scope, opts \\ []) do
    ...
    maybe_track_task_execution(task_id)
    task
  end

  defp maybe_track_task_execution(task_id) do
    case Code.ensure_loaded?(FrontmanServerWeb.ChannelCase) do
      true -> FrontmanServerWeb.ChannelCase.track_task_execution(task_id)
      false -> :ok
    end
  end
