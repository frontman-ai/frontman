...
defmodule FrontmanServer.Agents.SystemPrompt do
  ...
  defp framework_guidance(:astro) do
    ...
    - Call `get_resolved_astro_config` before changing routing, SSR/static behavior, adapters, i18n, images, Markdown/MDX, redirects, sessions, security, or deployment behavior.
