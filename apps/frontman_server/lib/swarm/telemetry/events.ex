defmodule Swarm.Telemetry.Events do
  @moduledoc """
  Telemetry event name definitions for Swarm.

  Single source of truth for event names used by `Swarm.Telemetry` (emitter)
  ...
  ## Example
      ...
      :telemetry.attach_many("my-handler", Swarm.Telemetry.Events.all(), &handler/4, nil)
  """
  def all do
    [
      run_start(),
