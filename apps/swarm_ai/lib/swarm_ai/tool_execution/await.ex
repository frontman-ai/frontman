defmodule SwarmAi.ToolExecution.Await do
  ...
  Then waits for `{:tool_result, message_key, content, is_error, metadata}` in its
  ...
  typedstruct enforce: true do
    ...
    # PE matches {:tool_result, message_key, content, is_error, metadata} in its receive loop
