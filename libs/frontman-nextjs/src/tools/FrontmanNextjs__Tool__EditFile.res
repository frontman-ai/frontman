// Next.js-enhanced EditFile tool
//
// Wraps the core edit_file tool and checks Next.js's own LogCapture for
// compilation errors 800ms after the edit. Uses the Next.js-specific
...
let execute = async (ctx: Tool.serverExecutionContext, input: input): Tool.toolResult<output> => {
  ...
  | Ok(output) =>
    // Wait 800ms for Next.js HMR to process the change
    await sleep(800)
