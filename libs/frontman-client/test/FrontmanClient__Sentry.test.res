...
describe("FrontmanClient Sentry", () => {
  ...
  describe("captureConnectionError", () => {
    test("captures connection error with endpoint context", t => {
      Sentry.captureConnectionError("Socket connection failed", ~endpoint="wss://example.com/socket")
    ...
    test("does not capture when not initialized", t => {
      Sentry.reset()
  ...
  describe("captureProtocolError", () => {
    test("captures ACP protocol error", t => {
    ...
    test("captures MCP protocol error", t => {
  ...
  describe("captureException", () => {
    test("captures exception with operation context", t => {
  ...
  describe("addBreadcrumb", () => {
    test("adds breadcrumb for connection events", t => {
    ...
    test("supports all breadcrumb categories", t => {
  ...
  describe("integration scenarios", () => {
    ...
    test("breadcrumbs accumulate across operations", t => {
