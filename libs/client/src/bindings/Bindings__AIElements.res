...
module Message = {
  ...
  external make: (~from: string, ~className: string=?, ~children: React.element) => React.element =
    "Message"
}
...
module PromptInputTextarea = {
  @react.component @module("@/components/ai-elements/prompt-input")
  external make: (~onChange: ReactEvent.Form.t => unit, ~value: string) => React.element =
    "PromptInputTextarea"
}
...
module PromptInputButton = {
  ...
  external make: (
    ...
    ~onClick: unit => unit,
    ~children: React.element,
  ) => React.element = "PromptInputButton"
}
...
module PromptInputModelSelect = {
  ...
  external make: (
    ...
    ~value: string,
    ~children: React.element,
  ) => React.element = "PromptInputModelSelect"
}
...
module WebPreviewNavigationButton = {
  ...
  external make: (
    ...
    ~tooltip: string=?,
    ~children: React.element,
  ) => React.element = "WebPreviewNavigationButton"
}
...
module WebPreviewConsole = {
  ...
  external make: (
    ...
    ~children: React.element=?,
  ) => React.element = "WebPreviewConsole"
}
...
module QueueSectionLabel = {
  ...
  external make: (
    ...
    ~icon: React.element=?,
    ~className: string=?,
  ) => React.element = "QueueSectionLabel"
}
...
module QueueItemContent = {
  ...
  external make: (
    ...
    ~className: string=?,
    ~children: React.element,
  ) => React.element = "QueueItemContent"
}
...
module QueueItemDescription = {
  ...
  external make: (
    ...
    ~className: string=?,
    ~children: React.element,
  ) => React.element = "QueueItemDescription"
}
...
module QueueItemImage = {
  @react.component @module("@/components/ai-elements/queue")
  external make: (~src: string, ~alt: string=?, ~className: string=?) => React.element =
    "QueueItemImage"
}
